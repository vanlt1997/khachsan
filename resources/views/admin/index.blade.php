    ...
    <div class="container">
        <section class="content">
                    ...
                    @if(Auth::user()->roles->first()->name === 'admin')
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="{{route('admin.revenues.index')}}" class="small-box-footer">More info <i
                                            class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <a href="{{route('admin.type-rooms.index')}}"><span
                                                class="info-box-text">Type Room</span></a>
            ...
            @if(Auth::user()->roles->first()->name === 'admin')
                <div class="row mt-5">
                    <div class="col-md-12">
                        <a href="{{route('admin.revenues.index')}}" class="text-danger pl-3 mt-5"
                           style="border-left: 3px solid #0b93d5">Report during year</a>
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <a href="{{route('admin.calendars.rooms')}}" class="text-danger pl-3 mt-5 mb-5"
...
@push('scripts')
    ...
    <script>
        var userLogin = '{{Auth::user()->roles->first()->name}}';
        ...
        function loadData() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['chartYear'].length && userLogin === 'admin') {
