...
@section('slidebar')
    ...
    <div class="container">
        <div class="row justify-content-center ftco-animate">
            <div class="col-lg-6 col-md-6 reservation pt-5 pb-5 " style="margin-top: -630px !important;">
                <div class="text-danger text-center mb-5"><h3 class="text-danger">{{ __('Register') }}</h3></div>
                <div class="block-17">
